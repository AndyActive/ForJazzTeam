...
public class Main {
    ...
    public static String numbersToString(String enter) {
        ...
        if (Integer.parseInt(enter) < 20) {
            if (count == 1 && enter.equals("1")) return dig1[20];
            if (count == 1 && enter.equals("2")) return dig1[21];
            ...
            if (Integer.parseInt(two) + Integer.parseInt(three) < 20 && (two.equals("1") || two.equals("0"))) {
                ...
                if (three.equals("00")) return dig100[Integer.parseInt(one) - 1];
    ...
    public static String addDegreeNames(String enter) {
        ...
        if (count == 0 || lastDigit1 == 0) return "";
                ...
                if (lastDigit == 1 && !enterOld.contains("11")) return digStandart[count - 1] + ending[0] + " ";
                ...
                else                                            return digStandart[count - 1] + " ";
        } else if (lastDigit == 1)  return digStandart[count - 1] + " ";
          else if (lastDigit < 5)   return digStandart[count - 1] + ending[1] + " ";
